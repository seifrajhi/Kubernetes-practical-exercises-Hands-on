...
How this happens is well outside of the scope of this workshop.
...
Then go to the address in your browser `http://{EXTERNAL_IP}/api/info/` and you should get the same JSON response as before.
